...
% CBFlimmap=[0 65];% 
% figure, 
% subplot 121, mmontage(rot90(nanmean(data,4).*brainmask),[5,4]); caxis(CBFlimmap); colormap(jet_black);%
% subplot 122, mmontage(rot90(nanmean(data_step2,4).*brainmask),[5,4]); caxis(CBFlimmap); colormap(jet_black);%
